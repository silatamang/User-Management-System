...
echo("
  <form method=\"post\" action=\"delete_action.php?sessionid=$sessionid&userid=$userid&utype=$utype\">
  <center>Are you sure you you want to delete <b>$userid</b>?</center> <br /> 
<input type=\"submit\" value=\"Yes\">
  </form>

  <form method=\"post\" action=\"display_users.php?sessionid=$sessionid\">
  <center><input type=\"submit\" value=\"No\"></center>
  </form>
  ");
